...
import ImportPurchase from "../../Component/ImportPurchase";

function Purchases() {
    const [showAddLeave, setShowAddLeave] = useState(false);
    const [showAddLeave1, setShowAddLeave1] = useState(false);
    ...
    const handleCloseAddLeave1 = () => {
      setShowAddLeave1(false);
    };
  
    const handleClick1 = () => {
      setShowAddLeave1(true);
    };
  return (
    <>
      <div className="page-wrapper" style={{ minHeight: "239px;" }}>
        <div className="content">
          ...
          {showAddLeave && <AddPurchase onClose={handleCloseAddLeave} />}

              <div className="page-btn import"  onClick={handleClick1}>
                <a
                  href="#"
              ...
              {showAddLeave1 && <ImportPurchase onClose={handleCloseAddLeave1} />}
            </div>
          </div>
          ...
          <div className="card table-list-card">
            <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-czab"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-um2b">
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-kxlk"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-1trb-container"
                              aria-controls="select2-1trb-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-1trb-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-73ez"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-gfp4">
                            Choose Status
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-59h3"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-fgfy-container"
                              aria-controls="select2-fgfy-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-fgfy-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Status"
                              >
                    ...
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        <svg
                          ...
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          className="feather feather-file info-img"
                        >
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-10-u9bs"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-12-qs9m">
                            Enter Reference
                          </option>
                          <option>PT001</option>
                          <option>PT002</option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-11-xjbm"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-8yhv-container"
                              aria-controls="select2-8yhv-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-8yhv-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-13-2vxn"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-15-6n41">
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-14-u0b0"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-lzl7-container"
                              aria-controls="select2-lzl7-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-lzl7-container"
                                role="textbox"
                                aria-readonly="true"
              ...
              <div className="table-responsive product-list">
                ...
                >
                  <table
                    className="table datanew list dataTable no-footer"
...
: activate to sort column descending"
                    ...
                    <tbody>
                      ...
                      <tr className="odd">
                        ...
                        <td>08 Feb 2023</td>
                        <td>
                          <span className="badges status-badge ordered">
                            Ordered
                          </span>
                        </td>
                        <td>$400</td>
