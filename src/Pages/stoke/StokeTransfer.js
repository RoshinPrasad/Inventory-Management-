...
import AddStockTransfer from "../../Component/AddStockTransfer";

function StokeTransfer() {
    ...
    <>
      <div className="page-wrapper" style={{ minHeight: "239px;" }}>
        <div className="content">
          ...
          {showAddLeave && <AddStockTransfer onClose={handleCloseAddLeave} />}
                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-dek7"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-4v5g">
                            Warehouse From
                          </option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-ti64"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-t4pm-container"
                              aria-controls="select2-t4pm-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-t4pm-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-h2po"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-aspk">
                            Warehouse To
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-g7o0"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-ytae-container"
                              aria-controls="select2-ytae-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-ytae-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Warehouse To"
                              >
...
: activate to sort column descending"
                        ...
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="From Warehouse: activate to sort column ascending"
                        ...
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="To Warehouse: activate to sort column ascending"
                          style={{ width: "98.7396px;" }}
                        >
                          To Warehouse
                        </th>
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="No of Products: activate to sort column ascending"
                          style={{ width: "101.75px;" }}
                        >
                          No of Products
                        </th>
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Quantity transfered: activate to sort column ascending"
                          style={{ width: "133.875px;" }}
                        >
                          Quantity transfered
                        </th>
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Ref Number: activate to sort column ascending"
                          style={{ width: "82.3646px;" }}
                        >
                          Ref Number
                        </th>
                        <th
