...
import AddStockAdj from "../../Component/AddStockAdjustment";

function StokeAdjustment() {
    ...
    <>
      <div className="page-wrapper" style={{ minHeight: "239px;" }}>
        <div className="content">
          ...
          {showAddLeave && <AddStockAdj onClose={handleCloseAddLeave} />}
                  ...
                  <div className="row">
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-zd9j"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-lu2d">
                            Choose Warehouse
                          </option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-4v1s"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-rqk1-container"
                              aria-controls="select2-rqk1-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-rqk1-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-cr6x"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-usro">
                            Choose Product
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-ela5"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-epv2-container"
                              aria-controls="select2-epv2-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-epv2-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-10-3t4c"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-12-7xbd">
                            Choose Person
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-11-q9zl"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-msjb-container"
                              aria-controls="select2-msjb-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-msjb-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Person"
                              >
...
export default StokeAdjustment;
