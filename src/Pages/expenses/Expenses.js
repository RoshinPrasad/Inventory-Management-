    ...
    <>
      <div className="page-wrapper" style={{ minHeight: "239px;" }}>
        <div className="content">
          ...
          {showAddLeave && <AddExpense onClose={handleCloseAddLeave} />}
                  ...
                  <div className="row">
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-5wxz"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-s6xn">
                            Choose Name
                          </option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-wqi6"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-63uq-container"
                              aria-controls="select2-63uq-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-63uq-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Name"
                              >
                    ...
                    <div className="col-lg-2 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-fkpt"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-jr6g">
                            Choose Status
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-cml4"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-7pim-container"
                              aria-controls="select2-7pim-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-7pim-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Status"
                              >
