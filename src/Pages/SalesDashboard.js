    ...
    <div className="content">
        <div className="welcome d-lg-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center welcome-text">
                <h3 className="d-flex align-items-center"><img src="../images/hi.svg" alt="img" />&nbsp;Hi John Smilga,
            ...
            <div className="d-flex align-items-center">
                <div className="position-relative daterange-wraper me-2">
                    <div className="input-groupicon calender-input">
                        <input type="text" className="form-control  date-range bookingrange" placeholder="Select" value="13 Aug 1992" />
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        className="feather feather-calendar feather-14">
                ...
                <button type="button" data-toggle="tooltip" className="btn btn-white-outline d-none d-md-inline-block"
                    data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh"
                    data-bs-original-title="Refresh"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" className="feather feather-rotate-ccw feather-16">
                        <polyline points="1 4 1 10 7 10"></polyline>
                        <path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"></path>
                    </svg></button>
                <a href="#" className="d-none d-lg-inline-block" data-bs-toggle="tooltip" data-bs-placement="top"
                    id="collapse-header" aria-label="Collapse" data-bs-original-title="Collapse"><svg
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        className="feather feather-chevron-up feather-16">
        ...
        <div className="row sales-cards">
            <div className="col-xl-6 col-sm-12 col-12">
                <div className="card d-flex align-items-center justify-content-between default-cover mb-4">
                    <div>
                        ...
                        <h3>$<span className="counters" data-count="95000.45">95000.45</span></h3>
                        <p className="sales-range"><span className="text-success"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-xl-3 col-sm-6 col-12">
                <div className="card color-info bg-primary mb-4">
                    ...
                    <h3 className="counters" data-count="10000.00">10000</h3>
                    <p>No of Total Sales</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        className="feather feather-rotate-ccw feather-16" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            <div className="col-xl-3 col-sm-6 col-12">
                <div className="card color-info bg-secondary mb-4">
                    ...
                    <h3 className="counters" data-count="800.00">800</h3>
                    <p>No of Total Sales</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        className="feather feather-rotate-ccw feather-16" data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <div className="card flex-fill default-cover w-100 mb-4">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div className="dropdown">
                            <a href="javascript:void(0);" className="view-all d-flex align-items-center">
                                View All<span className="ps-2 d-flex align-items-center"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" className="feather feather-arrow-right feather-16">
                            ...
                            <table className="table table-borderless recent-transactions">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div className="product-info">
                                                ...
                                                <div className="info">
                                                    ...
                                                    <span className="dull-text d-flex align-items-center"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round"
                                                            className="feather feather-clock feather-14">
                                        ...
                                        <td><span className="badge background-less border-success">Success</span></td>
                                        <td>$1,099.00</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        ...
                                        <td><span className="badge background-less border-danger">Canceled</span></td>
                                        <td>$600.55</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        ...
                                        <td><span className="badge background-less border-primary">Pending</span></td>
                                        <td>$1,099.00</td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
        ...
        <div className="row sales-board">
            <div className="col-md-12 col-lg-7 col-sm-12 col-12">
                <div className="card flex-fill default-cover">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div className="graph-sets">
                            <div className="dropdown dropdown-wraper">
                                <button className="btn btn-white btn-sm dropdown-toggle d-flex align-items-center"
                    ...
                    <div className="card-body">
                        <div id="sales-analysis" className="chart-set" style={{minHeight: "288px"}}>
                            <div id="apexchartsy3msk589"
                                className="apexcharts-canvas apexchartsy3msk589 apexcharts-theme-light"
                                style={{width: "881px", height: "273px;"}}>
                                <div className="apexcharts-tooltip apexcharts-theme-light">
                                    <div className="apexcharts-tooltip-title"
                                        style={{fontFamily: "Helvetica, Arial, sans-serif", fontSize: "12px;"}}></div>
                                    <div className="apexcharts-tooltip-series-group" style={{order: "1;"}}><span
                                            className="apexcharts-tooltip-marker"
                                            style={{backgroundColor: "rgb(255, 159, 67);"}}></span>
                                        <div className="apexcharts-tooltip-text"
                                            ...
                                            <div className="apexcharts-tooltip-y-group"><span
                                                    ...
                                                    className="apexcharts-tooltip-text-y-value"></span></div>
                                ...
                                <div
                                    ...
                                    <div className="apexcharts-xaxistooltip-text"
                                        style={{fontFamily: "Helvetica, Arial, sans-serif", fontSize: "12px;"}}></div>
                                </div>
                                <div
                                ...
                                <div className="apexcharts-toolbar" style={{top: "0px", right: "3px;"}}>
                                    <div className="apexcharts-menu-icon" title="Menu"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                    ...
                                    <div className="apexcharts-menu">
                                        <div className="apexcharts-menu-item exportSVG" title="Download SVG">Download SVG
                                        </div>
                                        <div className="apexcharts-menu-item exportPNG" title="Download PNG">Download PNG
                                        </div>
                                        <div className="apexcharts-menu-item exportCSV" title="Download CSV">Download CSV
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="card default-cover">
                    ...
                    <div className="card-body">
                        <div id="sales_db_world_map" style={{height: "265px;"}}>
                            <div className="jvectormap-container" style={{backgroundColor: "transparent;"}}><svg width="610.25"
                                    height="265">
                                    <defs></defs>
                                    <g transform="scale(0.6013074774276485) translate(57.435898361522966, 0)">
                                        <path
                                            ...
                                            data-code="BD" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="BE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="BF" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="BG" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="BA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M707.48,273.58l0.68,-0.65l1.41,-0.91l-0.15,1.63l-0.81,-0.05l-0.61,0.58l-0.53,-0.6Z"
                                            data-code="BN" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="BO" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="JP" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M495.45,295.49l-1.08,-2.99l1.14,-0.11l0.64,-1.19l0.76,0.09l0.65,1.83l-2.1,2.36Z"
                                            data-code="BI" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="BW" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="BR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="BS" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="BY" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M198.03,244.38l0.1,-4.49l0.69,-0.06l0.74,-1.3l0.34,0.28l-0.4,1.3l0.17,0.58l-0.34,2.25l-1.3,1.42Z"
                                            data-code="BZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="RS" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path d="M734.55,307.93l-0.1,-0.97l4.5,-0.86l-2.82,1.28l-1.59,0.55Z"
                                            data-code="TL" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="TM" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="TJ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="RO" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="GW" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="GT" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="GR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path d="M448.79,279.62l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z"
                                            data-code="GQ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="GY" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="GE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="GB" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="GM" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="GL" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="GH" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="JO" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="HR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="HT" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="HU" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="PT" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="PY" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="PA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="PG" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="PE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="PK" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="PH" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="PL" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="ZM" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="EH" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="EE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="EG" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="ZA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="EC" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="IT" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="VN" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="SB" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="ET" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="ES" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="ER" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M468.91,172.53l-1.22,-1.02l0.47,-1.81l0.89,-0.72l2.26,1.51l-0.5,0.57l-0.75,-0.27l-1.14,1.73Z"
                                            data-code="ME" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MD" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MG" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="UZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MM" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="ML" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MN" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MK" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MW" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="UG" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MY" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MX" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="IL" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="FJ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="FK" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="NI" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="NL" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="NO" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="NA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path d="M839.04,322.8l0.22,1.14l-0.44,0.03l-0.2,-1.45l0.42,0.27Z"
                                            data-code="VU" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path d="M838.78,341.24l-0.33,0.22l-2.9,-1.75l-3.26,-3.37l1.65,0.83l4.85,4.07Z"
                                            data-code="NC" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="NE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="NG" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="NZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="NP" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M472.77,172.64l-1.08,-1.29l0.96,-0.77l0.29,-0.83l1.98,1.64l-0.36,0.67l-1.79,0.58Z"
                                            data-code="XK" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CI" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CH" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CO" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CN" fill="#000NaN" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CM" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CL" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path d="M504.91,192.87l0.34,0.01l0.27,-0.07l-0.29,0.26l-0.31,-0.2Z"
                                            data-code="XC" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CG" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CF" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CD" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M504.36,193.47l0.43,0.28l-1.28,0.57l-0.92,-0.28l-0.24,-0.46l2.01,-0.13Z"
                                            data-code="CY" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="CU" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M500.35,351.36l0.5,2.04l-0.38,0.89l-1.05,0.21l-1.23,-1.2l-0.02,-0.64l0.83,-1.57l1.34,0.27Z"
                                            data-code="SZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="SY" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="SS" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="SR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="KH" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M195.8,250.13l1.4,-1.19l2.24,1.45l0.98,-0.27l0.44,0.2l-0.27,1.05l-1.14,-0.03l-3.64,-1.21Z"
                                            data-code="SV" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="SK" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="KR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            data-code="SN" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="SL" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="KZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="SA" fill="#000NaN" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="SE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="SD" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="DO" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="DJ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="DK" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="DE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="YE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="DZ" fill="#000NaN" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="US" fill="#000NaN" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="UY" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M510.37,198.01l-0.88,0.51l1.82,-3.54l0.62,0.08l0.22,0.61l-1.13,0.88l-0.65,1.47Z"
                                            data-code="LB" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="LA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M724.01,226.68l-0.74,1.48l-0.9,-1.52l-0.25,-1.74l1.38,-2.44l1.73,-1.74l0.64,0.44l-1.85,5.52Z"
                                            data-code="TW" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path d="M266.64,259.32l0.28,-1.16l1.13,-0.22l-0.06,1.2l-1.35,0.18Z"
                                            data-code="TT" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="TR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M624.16,268.99l-1.82,0.48l-0.99,-1.67l-0.42,-3.46l0.95,-3.43l1.21,0.98l2.26,4.19l-0.34,2.33l-0.85,0.58Z"
                                            data-code="LK" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="LV" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="LT" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path d="M436.08,149.45l-0.48,-0.07l0.3,-1.28l0.27,0.4l-0.09,0.96Z"
                                            data-code="LU" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="LR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M491.06,363.48l-0.49,0.15l-1.49,-1.67l1.1,-1.43l2.19,-1.44l1.51,1.27l-0.98,1.82l-1.23,0.38l-0.62,0.93Z"
                                            data-code="LS" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="TH" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M596.68,420.38l-3.2,0.18l-0.05,-1.26l0.39,-1.41l1.3,0.78l2.08,0.35l-0.52,1.36Z"
                                            data-code="TF" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="TG" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="TD" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="LY" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="VE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AF" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="IQ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="IS" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="IR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AM" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AL" fill="#000NaN" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AO" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AR" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AU" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AT" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="IN" fill="#000NaN" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="TZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="AZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="IE" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="ID" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="UA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            d="M549.33,221.64l-0.76,-0.23l-0.14,-1.64l0.84,-1.29l0.47,0.52l0.04,1.34l-0.45,1.3Z"
                                            data-code="QA" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                        <path
                                            ...
                                            data-code="MZ" fill="#ECECEC" fill-opacity="1" stroke="none"
                                            stroke-width="0" stroke-opacity="1" fill-rule="evenodd"
                                            className="jvectormap-region jvectormap-element"></path>
                                    </g>
                                    <g></g>
