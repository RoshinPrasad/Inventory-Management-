    ...
    <div className="page-wrapper">
      <div className="content">
        <div className="page-header">
          ...
          {showAddLeave && <AddAttendance onClose={handleCloseAddLeave} />}


        <div
          className="card table-list-card"
          data-select2-id="select2-data-36-vrn7"
        >
          <div className="card-body pb-0" data-select2-id="select2-data-35-vwoq">
            <div className="table-top">
              ...
              <div className="search-path d-flex align-items-center search-path-new">
                <div className="d-flex align-items-center">
                  ...
                  <a href="javascript:void(0);" className="btn-grid active">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <div className="row">
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        ...
                        data-select2-id="select2-data-4-4xx4"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-6-x6am">
                          Choose Name
                        </option>
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-5-2y91"
                        style={{width: "100%;"}}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-xnmy-container"
                            aria-controls="select2-xnmy-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-xnmy-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Choose Name"
                            >
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        className="select select2-hidden-accessible"
                        data-select2-id="select2-data-7-um1t"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-9-plys">
                          Choose Status
                        </option>
                      ...
                      <span
                        className="select2 select2-container select2-container--default"
                        dir="ltr"
                        data-select2-id="select2-data-8-6v4a"
                        style={{width: "100%;"}}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-1jhg-container"
                            aria-controls="select2-1jhg-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-1jhg-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Choose Status"
                            >
            ...
            <div
              ...
              data-select2-id="select2-data-34-k9yu"
            >
              <div
                id="DataTables_Table_0_wrapper"
                className="dataTables_wrapper dt-bootstrap5 no-footer table-responsive"
                data-select2-id="select2-data-DataTables_Table_0_wrapper"
              >
                <table
                  className="table datanew dataTable no-footer"
                  id="DataTables_Table_0"
                  aria-describedby="DataTables_Table_0_info"
                  data-select2-id="select2-data-DataTables_Table_0"
                >
                  <thead>
                    <tr>
                      <th
                  ...
                  <tbody data-select2-id="select2-data-33-ubg8">
                    <tr className="odd">
                      ...
                      <td>
                        <div className="userimgname">
                          ...
                          <div>
                            ...
                            <span className="emp-team">Administrator</span>
                          </div>
                        </div>
                      </td>
                      <td>POS001</td>
                    ...
                    <tr className="even">
                      ...
                      <td>
                        <div className="userimgname">
                          ...
                          <div>
                            ...
                            <span className="emp-team">Administrative</span>
                          </div>
                        </div>
                      </td>
                      <td>POS003</td>
                      ...
                      <td>
                        <div
                          className="input-blocks leave-table"
                          data-select2-id="select2-data-32-ya4p"
                        >
                          <select
                            className="select select2-hidden-accessible"
                            data-select2-id="select2-data-10-957i"
                            tabindex="-1"
                            aria-hidden="true"
                          >
                            <option data-select2-id="select2-data-12-nm6j">
                              Approve
                            </option>
                            <option data-select2-id="select2-data-38-rgso">
                              Rejected
                            </option>
                          </select>
                          <span
                            ...
                            dir="ltr"
                            data-select2-id="select2-data-11-d3p0"
                            style={{width: "100%;"}}
                          >
                            <span className="selection">
                              <span
                                ...
                                tabindex="0"
                                aria-disabled="false"
                                aria-labelledby="select2-ctcf-container"
                                aria-controls="select2-ctcf-container"
                              >
                                <span
                                  className="select2-selection__rendered"
                                  id="select2-ctcf-container"
                                  role="textbox"
                                  aria-readonly="true"
                                  title="Approve"
                                >
                    ...
                    <tr className="odd">
                      ...
                      <td>
                        <div
                          className="input-blocks leave-table"
                          data-select2-id="select2-data-40-3ndj"
                        >
                          <select
                            className="select select2-hidden-accessible"
                            data-select2-id="select2-data-13-dh0n"
                            tabindex="-1"
                            aria-hidden="true"
                          >
                            <option data-select2-id="select2-data-15-ovic">
                              Approve
                            </option>
                            <option data-select2-id="select2-data-41-rdl5">
                              Rejected
                            </option>
                          </select>
                          <span
                            className="select2 select2-container select2-container--default select2-container--below"
                            dir="ltr"
                            data-select2-id="select2-data-14-6clg"
                            style={{width: "100%;"}}
                          >
                            <span className="selection">
                              <span
                                ...
                                tabindex="0"
                                aria-disabled="false"
                                aria-labelledby="select2-gery-container"
                                aria-controls="select2-gery-container"
                              >
                                <span
                                  className="select2-selection__rendered"
                                  id="select2-gery-container"
                                  role="textbox"
                                  aria-readonly="true"
                                  title="Approve"
                                >
                    ...
                    <tr className="even">
                      ...
                      <td>
                        <div
                          className="input-blocks leave-table"
                          data-select2-id="select2-data-43-k4ky"
                        >
                          <select
                            className="select select2-hidden-accessible"
                            data-select2-id="select2-data-16-z1f8"
                            tabindex="-1"
                            aria-hidden="true"
                          >
                            <option data-select2-id="select2-data-18-5qrf">
                              Approve
                            </option>
                            <option data-select2-id="select2-data-44-od8k">
                              Rejected
                            </option>
                          </select>
                          <span
                            className="select2 select2-container select2-container--default select2-container--below"
                            dir="ltr"
                            data-select2-id="select2-data-17-ktr1"
                            style={{width: "100%;"}}
                          >
                            <span className="selection">
                              <span
                                ...
                                tabindex="0"
                                aria-disabled="false"
                                aria-labelledby="select2-57mi-container"
                                aria-controls="select2-57mi-container"
                              >
                                <span
                                  className="select2-selection__rendered"
                                  id="select2-57mi-container"
                                  role="textbox"
                                  aria-readonly="true"
                                  title="Approve"
                                >
                    ...
                    <tr className="odd">
                      ...
                      <td>
                        <div className="userimgname">
                          ...
                          <div>
                            ...
                            <span className="emp-team">Secretary</span>
                          </div>
                        </div>
                      </td>
                      <td>POS006</td>
                      ...
                      <td>
                        <div
                          className="input-blocks leave-table"
                          data-select2-id="select2-data-46-9p6z"
                        >
                          <select
                            className="select select2-hidden-accessible"
                            data-select2-id="select2-data-19-qugn"
                            tabindex="-1"
                            aria-hidden="true"
                          >
                            <option data-select2-id="select2-data-21-fsyc">
                              Approve
                            </option>
                            <option data-select2-id="select2-data-47-jv7d">
                              Rejected
                            </option>
                          </select>
                          <span
                            className="select2 select2-container select2-container--default select2-container--below"
                            dir="ltr"
                            data-select2-id="select2-data-20-lt25"
                            style={{width: "100%;"}}
                          >
                            <span className="selection">
                              <span
                                ...
                                tabindex="0"
                                aria-disabled="false"
                                aria-labelledby="select2-mxy0-container"
                                aria-controls="select2-mxy0-container"
                              >
                                <span
                                  className="select2-selection__rendered"
                                  id="select2-mxy0-container"
                                  role="textbox"
                                  aria-readonly="true"
                                  title="Approve"
                                >
                    ...
                    <tr className="even">
                      ...
                      <td>
                        <div className="input-blocks leave-table">
                          <select
                            className="select select2-hidden-accessible"
                            data-select2-id="select2-data-22-sdnr"
                            tabindex="-1"
                            aria-hidden="true"
                          >
                            <option data-select2-id="select2-data-24-c7s9">
                              Approve
                            </option>
                            <option>Rejected</option>
                          </select>
                          <span
                            className="select2 select2-container select2-container--default"
                            dir="ltr"
                            data-select2-id="select2-data-23-wxui"
                            style={{width: "100%;"}}
                          >
                            <span className="selection">
                              <span
                                ...
                                tabindex="0"
                                aria-disabled="false"
                                aria-labelledby="select2-0jvv-container"
                                aria-controls="select2-0jvv-container"
                              >
                                <span
                                  className="select2-selection__rendered"
                                  id="select2-0jvv-container"
                                  role="textbox"
                                  aria-readonly="true"
                                  title="Approve"
                                >
