                ...
                <div className="row">
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        ...
                        data-select2-id="select2-data-4-dda3"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-6-k2ys">
                          Choose Shift
                        </option>
                        <option>Fixed</option>
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-5-ffg4"
                        style={{width: "100%;"}}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-49hb-container"
                            aria-controls="select2-49hb-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-49hb-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Choose Shift"
                            >
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        className="select select2-hidden-accessible"
                        data-select2-id="select2-data-7-1ln3"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-9-qn9t">
                          Choose Status
                        </option>
                      ...
                      <span
                        className="select2 select2-container select2-container--default"
                        dir="ltr"
                        data-select2-id="select2-data-8-gk87"
                        style={{width: "100%;"}}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-v9ca-container"
                            aria-controls="select2-v9ca-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-v9ca-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Choose Status"
                            >
                  ...
                  <thead>
                    <tr>
                      ...
                      <th
                        ...
                        rowspan="1"
                        colspan="1"
                        aria-label="Shift Name: activate to sort column ascending"
                        style={{width: "131.512px;"}}
                      >
                        Shift Name
                      </th>
                      <th
                      ...
                      <th
                        ...
                        rowspan="1"
                        colspan="1"
                        aria-label="Week off: activate to sort column ascending"
                        style={{width: "168.012px;"}}
                      >
                        Week off
                      </th>
                      <th
