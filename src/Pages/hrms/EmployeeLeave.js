                ...
                <div className="row">
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        ...
                        data-select2-id="select2-data-4-4gfb"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-6-9dt4">
                          Choose Type
                        </option>
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-5-m9vp"
                        style={{width: "100%;"}}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-ejzk-container"
                            aria-controls="select2-ejzk-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-ejzk-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Choose Type"
                            >
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        className="select select2-hidden-accessible"
                        data-select2-id="select2-data-7-frls"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-9-4b2a">
                          Choose Employee
                        </option>
                      ...
                      <span
                        className="select2 select2-container select2-container--default"
                        dir="ltr"
                        data-select2-id="select2-data-8-0lbf"
                        style={{width: "100%;"}}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-yor3-container"
                            aria-controls="select2-yor3-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-yor3-container"
                              role="textbox"
                              aria-readonly="true"
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        className="select select2-hidden-accessible"
                        data-select2-id="select2-data-10-x140"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-12-v922">
                          Choose Status
                        </option>
                      ...
                      <span
                        className="select2 select2-container select2-container--default"
                        dir="ltr"
                        data-select2-id="select2-data-11-6g1o"
                        style={{width: "100%;"}}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-fe0l-container"
                            aria-controls="select2-fe0l-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-fe0l-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Choose Status"
                            >
                    ...
                    <tr className="odd">
                      ...
                      <td className="action-table-data justify-content-end">
                        <div className="edit-delete-action">
                          <a href="" className="me-2 cancel-circle">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
