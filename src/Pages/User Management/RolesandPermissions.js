  ...
  return (
    <div className="page-wrapper" style={{ minHeight: "764px" }}>
      <div className="content">
        ...
        {showAddLeave && <AddNewRole onClose={handleCloseAddLeave} />}
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        ...
                        data-select2-id="select2-data-4-yvwf"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-6-bukm">
                          Choose Role
                        </option>
                        <option>Admin</option>
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-5-2e65"
                        style={{ width: "100%" }}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-tic7-container"
                            aria-controls="select2-tic7-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-tic7-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Choose Role"
                            >
                    ...
                    <tr className="odd">
                      ...
                      <td className="action-table-data">
                        <div className="edit-delete-action">
                          ...
                          <a className="p-2 me-2" href="permissions.html">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
