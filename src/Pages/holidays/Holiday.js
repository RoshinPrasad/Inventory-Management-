...
import AddNewLeave from "../../Component/AddNewHoliday";
                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-j4uz"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-n0h3">
                            Choose Holiday
                          </option>
                          <option>UI/UX</option>
                          <option>HR</option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-6a46"
                          style={{ width: "100%" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-cj9q-container"
                              aria-controls="select2-cj9q-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-cj9q-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-hi5q"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-xufr">
                            Choose HOD
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-6sye"
                          style={{ width: "100%" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-4yq7-container"
                              aria-controls="select2-4yq7-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-4yq7-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose HOD"
                              >
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-10-94cz"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-12-5828">
                            Choose Status
                          </option>
                          <option>Mitchum Daniel</option>
                          <option>Susan Lopez</option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-11-h0ot"
                          style={{ width: "100%" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-raf3-container"
                              aria-controls="select2-raf3-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-raf3-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Status"
                              >
