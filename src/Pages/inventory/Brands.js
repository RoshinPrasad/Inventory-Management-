...
import AddNewBrand from "../../Component/AddNewBrand";
    ...
    <>
      <div className="page-wrapper" style={{ minHeight: "239px;" }}>
        <div className="content">
          ...
          {showAddLeave && <AddNewBrand onClose={handleCloseAddLeave} />}
                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-gyxl"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-wy16">
                            Choose Brand
                          </option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-ldln"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-caki-container"
                              aria-controls="select2-caki-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-caki-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Brand"
                              >
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-zfan"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-lepe">
                            Choose Status
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-wdfy"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-rbm5-container"
                              aria-controls="select2-rbm5-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-rbm5-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Status"
                              >
...
: activate to sort column descending"
                        ...
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Logo: activate to sort column ascending"
                          style={{ width: "82.9583px;" }}
                        >
                          Logo
                        </th>
                        <th
                    ...
                    <tbody>
                      <tr className="odd">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-01.png" alt="" />
                          </span>
                        </td>
                        <td>25 May 2023</td>
                        <td>
                      ...
                      <tr className="even">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-02.png" alt="" />
                          </span>
                        </td>
                        <td>24 Jun 2023</td>
                        <td>
                      ...
                      <tr className="odd">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-03.png" alt="" />
                          </span>
                        </td>
                        <td>23 Jul 2023</td>
                        <td>
                      ...
                      <tr className="even">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-04.png" alt="" />
                          </span>
                        </td>
                        <td>22 Aug 2023</td>
                        <td>
                      ...
                      <tr className="odd">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-05.png" alt="" />
                          </span>
                        </td>
                        <td>21 Sep 2023</td>
                        <td>
                      ...
                      <tr className="even">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-06.png" alt="" />
                          </span>
                        </td>
                        <td>20 Sep 2023</td>
                        <td>
                      ...
                      <tr className="odd">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-07.png" alt="" />
                          </span>
                        </td>
                        <td>20 Sep 2023</td>
                        <td>
                      ...
                      <tr className="even">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-08.png" alt="" />
                          </span>
                        </td>
                        <td>20 Sep 2023</td>
                        <td>
                      ...
                      <tr className="odd">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-09.png" alt="" />
                          </span>
                        </td>
                        <td>20 Sep 2023</td>
                        <td>
                      ...
                      <tr className="even">
                        ...
                        <td>
                          <span className="d-flex">
                            <img src="../../images/brand-icon-10.png" alt="" />
                          </span>
                        </td>
                        <td>20 Sep 2023</td>
                        <td>
