    ...
    <>
      <div className="page-wrapper" style={{ minHeight: "239px;" }}>
        <div className="content">
          ...
          {showAddLeave && <AddNewUnit onClose={handleCloseAddLeave} />}
                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-qkdm"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-3fv3">
                            Choose Unit
                          </option>
                          <option>Piece</option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-3msz"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-nh4i-container"
                              aria-controls="select2-nh4i-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-nh4i-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Unit"
                              >
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-fl94"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-hm43">
                            Choose Status
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-8mza"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-jqs3-container"
                              aria-controls="select2-jqs3-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-jqs3-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Status"
                              >
