...
import AddSalesReturn from "../../Component/AddSalesReturn";
    ...
    <>
      <div className="page-wrapper" style={{ minHeight: "239px;" }}>
        <div className="content">
          ...
          {showAddLeave && <AddSalesReturn onClose={handleCloseAddLeave} />}
                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-t3t9"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-l3l2">
                            Choose Customer
                          </option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-u55q"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-n0pu-container"
                              aria-controls="select2-n0pu-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-n0pu-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-ly6n"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-5xb4">
                            Choose Status
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-q8oa"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-kb9k-container"
                              aria-controls="select2-kb9k-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-kb9k-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Status"
                              >
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-10-q3gn"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-12-lbrq">
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-11-byhm"
                          style={{ width: "100%;" }}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-owzx-container"
                              aria-controls="select2-owzx-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-owzx-container"
                                role="textbox"
                                aria-readonly="true"
