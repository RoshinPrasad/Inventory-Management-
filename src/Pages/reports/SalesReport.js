                  ...
                  <div className="row">
                    <div className="col-lg-3">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-al0a"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-eaeq">
                            Choose Product
                          </option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-4txp"
                          style={{width: "100%"}}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-ubwd-container"
                              aria-controls="select2-ubwd-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-ubwd-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-3">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-jphj"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-yqml">
                            Choose Category
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-wibv"
                          style={{width: "100%"}}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-oa2m-container"
                              aria-controls="select2-oa2m-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-oa2m-container"
                                role="textbox"
                                aria-readonly="true"
...
: activate to sort column descending"
                        ...
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Sold Qty: activate to sort column ascending"
                          style={{width: "76.3977px"}}
                        >
                          Sold Qty
                        </th>
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Sold Amount: activate to sort column ascending"
                          style={{width: "111.534px"}}
                        >
                          Sold Amount
                        </th>
                        <th
