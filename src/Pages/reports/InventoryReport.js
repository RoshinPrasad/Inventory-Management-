                  ...
                  <div className="row">
                    <div className="col-lg-3">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-c5d6"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-orem">
                            Choose Product
                          </option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-adey"
                          style={{width: "100%"}}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-ub8v-container"
                              aria-controls="select2-ub8v-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-ub8v-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <div className="col-lg-3">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-xor5"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-as3h">
                            Choose Category
                          </option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-wysj"
                          style={{width: "100%"}}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-qw4m-container"
                              aria-controls="select2-qw4m-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-qw4m-container"
                                role="textbox"
                                aria-readonly="true"
