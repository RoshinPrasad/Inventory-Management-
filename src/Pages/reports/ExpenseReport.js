                ...
                <div className="row">
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        ...
                        data-select2-id="select2-data-4-21kn"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-6-z5qc">
                          Choose Category
                        </option>
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-5-q4px"
                        style={{ width: "100%" }}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-5sve-container"
                            aria-controls="select2-5sve-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-5sve-container"
                              role="textbox"
                              aria-readonly="true"
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    <div className="input-blocks">
                      ...
                      <select
                        className="select select2-hidden-accessible"
                        data-select2-id="select2-data-7-yieo"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-9-r4y4">
                          Created by
                        </option>
                      ...
                      <span
                        className="select2 select2-container select2-container--default"
                        dir="ltr"
                        data-select2-id="select2-data-8-bsi2"
                        style={{ width: "100%" }}
                      >
                        <span className="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-bhgr-container"
                            aria-controls="select2-bhgr-container"
                          >
                            <span
                              className="select2-selection__rendered"
                              id="select2-bhgr-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Created by"
                            >
...
: activate to sort column descending"
                      ...
                      <th
                        ...
                        rowspan="1"
                        colspan="1"
                        aria-label="Expense Category: activate to sort column ascending"
                        style={{ width: "251.613px" }}
                      >
                        Expense Category
                      </th>
                      <th
