                  ...
                  <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          ...
                          data-select2-id="select2-data-4-mhrr"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-6-6oam">
                            Choose Name
                          </option>
                          <option>Rose</option>
                        ...
                        <span
                          ...
                          dir="ltr"
                          data-select2-id="select2-data-5-6u72"
                          style={{width: "100%"}}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-aq0s-container"
                              aria-controls="select2-aq0s-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-aq0s-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Name"
                              >
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                      <div className="input-blocks">
                        ...
                        <select
                          className="select select2-hidden-accessible"
                          data-select2-id="select2-data-7-7u1o"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-9-6c6l">
                            Choose Status
                          </option>
                          <option>Paid</option>
                        ...
                        <span
                          className="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-8-t8xu"
                          style={{width: "100%"}}
                        >
                          <span className="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-jdxh-container"
                              aria-controls="select2-jdxh-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-jdxh-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose Status"
                              >
...
: activate to sort column descending"
                        ...
                        <th
                          ...
                          rowspan="1"
                          colspan="1"
                          aria-label="Amount Due: activate to sort column ascending"
                          style={{width: "126.966px"}}
                        >
                          Amount Due
                        </th>
                        <th
