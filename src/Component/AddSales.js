                  ...
                  <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-10 col-sm-10 col-10">
                            <select
                              ...
                              data-select2-id="select2-data-13-oyy0"
                              tabindex="-1"
                              aria-hidden="true"
                            >
                              <option data-select2-id="select2-data-15-ullk">
                                Choose
                              </option>
                            ...
                            <span
                              ...
                              dir="ltr"
                              data-select2-id="select2-data-14-kyh6"
                              style={{ width: "100%;" }}
                            >
                              <span class="selection">
                                <span
                                  ...
                                  tabindex="0"
                                  aria-disabled="false"
                                  aria-labelledby="select2-6trz-container"
                                  aria-controls="select2-6trz-container"
                                >
                                  <span
                                    class="select2-selection__rendered"
                                    id="select2-6trz-container"
                                    role="textbox"
                                    aria-readonly="true"
                                    title="Choose"
                                  >
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                      <div class="input-blocks">
                        ...
                        <select
                          class="select select2-hidden-accessible"
                          data-select2-id="select2-data-16-gx2n"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-18-7kr6">
                            Choose
                          </option>
                        ...
                        <span
                          class="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-17-2sny"
                          style={{ width: "100%;" }}
                        >
                          <span class="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-ftkg-container"
                              aria-controls="select2-ftkg-container"
                            >
                              <span
                                class="select2-selection__rendered"
                                id="select2-ftkg-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose"
                              >
                    ...
                    <div class="col-lg-12 col-sm-6 col-12">
                      <div class="input-blocks">
                        ...
                        <div class="input-groupicon select-code">
                          ...
                          />
                          <div class="addonset">
                            <img src="../images/qrcode-scan.svg" alt="img" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                      <div class="input-blocks mb-5">
                        ...
                        <select
                          class="select select2-hidden-accessible"
                          data-select2-id="select2-data-19-acnm"
                          tabindex="-1"
                          aria-hidden="true"
                        >
                          <option data-select2-id="select2-data-21-m2bh">
                            Choose
                          </option>
                        ...
                        <span
                          class="select2 select2-container select2-container--default"
                          dir="ltr"
                          data-select2-id="select2-data-20-633g"
                          style={{ width: "100%;" }}
                        >
                          <span class="selection">
                            <span
                              ...
                              tabindex="0"
                              aria-disabled="false"
                              aria-labelledby="select2-jks2-container"
                              aria-controls="select2-jks2-container"
                            >
                              <span
                                class="select2-selection__rendered"
                                id="select2-jks2-container"
                                role="textbox"
                                aria-readonly="true"
                                title="Choose"
                              >
