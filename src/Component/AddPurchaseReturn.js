...
const AddPurchaseReturn = ({onClose}) => {
  ...
  return (
    ...
    <div class="modal-content"  style={{
      ...
      <div class="page-wrapper p-0 m-0" style={{minHeight: "378px;"}}>
                      ...
                      <div class="row">
                        <div class="col-lg-10 col-sm-10 col-10">
                          <select
                            ...
                            data-select2-id="select2-data-10-res8"
                            tabindex="-1"
                            aria-hidden="true"
                          >
                            <option data-select2-id="select2-data-12-torb">
                              Choose
                            </option>
                          ...
                          <span
                            ...
                            dir="ltr"
                            data-select2-id="select2-data-11-3kxn"
                            style={{width: "100%;"}}
                          >
                            <span class="selection">
                              <span
                                ...
                                tabindex="0"
                                aria-disabled="false"
                                aria-labelledby="select2-4bqq-container"
                                aria-controls="select2-4bqq-container"
                              >
                                <span
                                  class="select2-selection__rendered"
                                  id="select2-4bqq-container"
                                  role="textbox"
                                  aria-readonly="true"
                                  title="Choose"
                                >
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6 col-12">
                    <div class="input-blocks mb-5">
                      ...
                      <select
                        class="select select2-hidden-accessible"
                        data-select2-id="select2-data-13-fp25"
                        tabindex="-1"
                        aria-hidden="true"
                      >
                        <option data-select2-id="select2-data-15-z7js">
                          Choose
                        </option>
                      ...
                      <span
                        class="select2 select2-container select2-container--default"
                        dir="ltr"
                        data-select2-id="select2-data-14-jd9m"
                        style={{width: "100%;"}}
                      >
                        <span class="selection">
                          <span
                            ...
                            tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-qz8t-container"
                            aria-controls="select2-qz8t-container"
                          >
                            <span
                              class="select2-selection__rendered"
                              id="select2-qz8t-container"
                              role="textbox"
                              aria-readonly="true"
                              title="Choose"
                            >
